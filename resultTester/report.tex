...
%  y unit=\si{\byte},
  flexible xticklabels from table={speedSame.csv}{impl}{col sep=comma},
  xticklabel style={text height=1.5ex},
  xtick=data,
  enlarge x limits=0.3,
  nodes near coords,
...
\addplot table[x expr=\coordindex,,y=cycles,col sep=comma] {speedSame.csv};
\end{axis}
\end{tikzpicture}
\caption{Average number of cycles in same translation unit.\label{fig:speedSameTranslationunit}}
\end{figure}
...
\begin{axis}[
  ...
  ylabel=cycles count,
%  y unit=\si{\byte},
  flexible xticklabels from table={speedSeparate.csv}{impl}{col sep=comma},
  xticklabel style={text height=1.5ex},
  xtick=data,
  enlarge x limits=0.3,
  nodes near coords,
...
\addplot table[x expr=\coordindex,y=cycles,col sep=comma] {speedSeparate.csv};
%\legend{.data, .bss, .text}
\end{axis}
\end{tikzpicture}
\caption{Average cycles count in separate translation units.\label{fig:speedSeparateTranslationunit}}
\end{figure}
\end{document}